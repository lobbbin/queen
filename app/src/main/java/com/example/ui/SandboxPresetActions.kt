...
object SandboxPresetActions {
    val items: List<PresetSandboxAction> = listOf(
        ...
        PresetSandboxAction(
            id = "court_21",
            category = "Malpractice & Courts",
            label = "⚖️ Narcotic Traffic Arrest",
            description = "INDITE DR. TIM: Unauthorized Narcotic Compounding Criminal Court Trial (Tier 2)",
            promptText = "[(SYSTEM ACTION)]: Federal apprehension units serve a criminal trial warrant for Narcotic compound trafficking.",
            hexColor = "#E64A19",
            kotlinLogic = "triggerCriminalTrial:Sipho Mokoena|Unauthorized Narcotic Compounding & Trafficking|2"
        ),
        PresetSandboxAction(
            id = "court_22",
            category = "Malpractice & Courts",
            label = "⚖️ Extortion Conspiracy Inquest",
            description = "INDITE DR. TIM: Regulatory Extortion Subversion Criminal Court Trial (Tier 3)",
            promptText = "[(SYSTEM ACTION)]: Federal judicial agents serve high criminal summons indicting Dr. Tim for subversion.",
            hexColor = "#E64A19",
            kotlinLogic = "triggerCriminalTrial:Nomsa Nkosi|Regulatory Extortion Subversion|3"
        ),
        PresetSandboxAction(
            id = "court_23",
            category = "Malpractice & Courts",
            label = "⚖️ Manslaughter Inquest",
            description = "INDITE DR. TIM: Catastrophic Therapy Negligence Criminal Court Trial (Tier 1)",
            promptText = "[(SYSTEM ACTION)]: National prosecutor charges practitioner with criminal negligence or manslaughter.",
            hexColor = "#E64A19",
            kotlinLogic = "triggerCriminalTrial:Bongani Cele|Catastrophic Therapy Negligence Investigation|1"
        ),
        PresetSandboxAction(
            id = "court_24",
            category = "Malpractice & Courts",
            label = "🧪 Sovereign Compounder",
            description = "Formulate a custom compound and record +20 stock units under overrideNationalFormulary",
            promptText = "[(SYSTEM ACTION)]: The practitioner formulates active custom substances on-the-fly and records units.",
            hexColor = "#4DB6AC",
            kotlinLogic = "triggerMedsStock:20"
        ),
